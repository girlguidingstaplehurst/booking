...
type ClientInterface interface {
	...
	//
	// Corresponds with GET /api/v1/admin/contacts (the `AdminListContacts` operationId).
	AdminListContacts(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error)
...
//
// Corresponds with GET /api/v1/admin/contacts (the `AdminListContacts` operationId).
func (c *Client) AdminListContacts(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewAdminListContactsRequest(c.Server)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewAdminListContactsRequest constructs an http.Request for the AdminListContacts method
func NewAdminListContactsRequest(server string) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/api/v1/admin/contacts")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type ClientWithResponsesInterface interface {
	...
	// AdminListContactsWithResponse List contacts
	//
	// Returns a wrapper object for the known response body format(s).
	//
	// Corresponds with GET /api/v1/admin/contacts (the `AdminListContacts` operationId).
	AdminListContactsWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*AdminListContactsResponse, error)
...
type AdminListContactsResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	// JSON200 the response for an HTTP 200 `application/json` response
	JSON200 *AdminContactList
	// JSON500 the response for an HTTP 500 `application/json` response
	JSON500 *ErrorResponse
}

// GetJSON200 returns the response for an HTTP 200 `application/json` response
func (r AdminListContactsResponse) GetJSON200() *AdminContactList {
	return r.JSON200
}

// GetJSON500 returns the response for an HTTP 500 `application/json` response
func (r AdminListContactsResponse) GetJSON500() *ErrorResponse {
	return r.JSON500
}

// GetBody returns the raw response body bytes
func (r AdminListContactsResponse) GetBody() []byte {
	return r.Body
}

// Status returns HTTPResponse.Status
func (r AdminListContactsResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r AdminListContactsResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r AdminListContactsResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
//
// Corresponds with GET /api/v1/admin/contacts (the `AdminListContacts` operationId).
func (c *ClientWithResponses) AdminListContactsWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*AdminListContactsResponse, error) {
	rsp, err := c.AdminListContacts(ctx, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseAdminListContactsResponse(rsp)
}
...
// ParseAdminListContactsResponse parses an HTTP response from a AdminListContactsWithResponse call
func ParseAdminListContactsResponse(rsp *http.Response) (*AdminListContactsResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &AdminListContactsResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
