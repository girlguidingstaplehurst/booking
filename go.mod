module github.com/girlguidingstaplehurst/booking
...
require (
	...
	github.com/purplepudding/bricks v0.17.1
...
require (
	...
	github.com/Jh123x/buildergen v0.3.0 // indirect
