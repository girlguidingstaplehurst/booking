...
const (
	...
	GreetServiceName = "v1.GreetService"
)
...
const (
	...
	GreetServiceGreetProcedure = "/v1.GreetService/Greet"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	greetServiceServiceDescriptor     = v1.File_v1_calendar_proto.Services().ByName("GreetService")
	greetServiceGreetMethodDescriptor = greetServiceServiceDescriptor.Methods().ByName("Greet")
)

// GreetServiceClient is a client for the v1.GreetService service.
type GreetServiceClient interface {
	Greet(context.Context, *connect.Request[v1.GreetRequest]) (*connect.Response[v1.GreetResponse], error)
}

// NewGreetServiceClient constructs a client for the v1.GreetService service. By default, it uses
...
// Greet calls v1.GreetService.Greet.
...
// GreetServiceHandler is an implementation of the v1.GreetService service.
...
func NewGreetServiceHandler(svc GreetServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/v1.GreetService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedGreetServiceHandler) Greet(context.Context, *connect.Request[v1.GreetRequest]) (*connect.Response[v1.GreetResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("v1.GreetService.Greet is not implemented"))
}
