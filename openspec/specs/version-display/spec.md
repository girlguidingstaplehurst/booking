...
Expose the release or Git revision represented by the running embedded frontend so administrators and users can identify the deployed application build.
...
- **THEN** the shared footer displays a safe generic development version instead of being blank or failing to build
